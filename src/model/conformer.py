...
from src.model.conformer_impl import ConformerEncoder
import torch

# uses own implementation of conformer

class ConformerImpl(nn.Module):
    """
    ...
    def __init__(self, n_tokens, input_dim, num_heads, ffn_dim, num_layers, kernel_size,
        ...
        self.conformer_encoder = ConformerEncoder(
            ...
            depthwise_kernel_size = kernel_size,
            dropout = dropout,
        )
        self.lstm = nn.LSTM(
